#!/usr/bin/env python3
"""
Teste de transcrição de áudio - Versão corrigida
"""
import asyncio
import sys
import os
...
# Forçar reimportação limpa
if 'openai' in sys.modules:
    del sys.modules['openai']
if 'src.audio.transcriber' in sys.modules:
    del sys.modules['src.audio.transcriber']

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

# Importar OpenAI primeiro para garantir versão correta
